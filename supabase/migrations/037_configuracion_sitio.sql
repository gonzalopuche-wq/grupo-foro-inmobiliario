...
insert into configuracion_sitio (clave, valor, tipo, label, categoria, descripcion) values
  ...
  ('jus_url_cocir', 'https://www.cajaforense.com/index.php?action=portal/show&ssnId_session=355&id_section=148&mnuId_parent=2', 'url', 'URL del JUS (Caja Forense)', 'jus',
    'Dirección de la página de Caja Forense donde figura el valor del JUS. Requerida para sincronización automática.'),

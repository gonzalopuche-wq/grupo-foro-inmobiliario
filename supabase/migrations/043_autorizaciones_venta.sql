...
drop policy if exists "autorizaciones_select" on autorizaciones_venta;
...
drop policy if exists "autorizaciones_insert" on autorizaciones_venta;
create policy "autorizaciones_insert" on autorizaciones_venta for insert
  with check (auth.uid() = user_id);

drop policy if exists "autorizaciones_update" on autorizaciones_venta;
...
drop policy if exists "autorizaciones_delete" on autorizaciones_venta;

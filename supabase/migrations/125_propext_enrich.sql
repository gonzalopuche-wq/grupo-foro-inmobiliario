...
SELECT
  ...
  ambientes,
  superficie_cubierta,
  superficie_total                                              AS sup_terreno,
  sup_semicubierta,
  sup_descubierta,
  expensas,
  orientacion,
...
BEGIN
  ...
  SELECT
    ...
    amb_parrilla AS com_parrilla, com_quincho, com_solarium, com_lavanderia AS com_laundry,
  ...
  SELECT
    ...
    superficie_cubierta, superficie_total AS sup_terreno, sup_semicubierta, sup_descubierta, expensas,

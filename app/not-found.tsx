  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", textAlign: "center", padding: "0 24px" }}>
        ...
        <Link href="/dashboard" style={{ display: "inline-block", padding: "11px 24px", background: "#990000", color: "#fff", borderRadius: 7, fontSize: 13, fontWeight: 700, fontFamily: "Montserrat,sans-serif", textDecoration: "none" }}>
          Volver al dashboard
        </Link>

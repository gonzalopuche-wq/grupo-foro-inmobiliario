  ...
  return (
    <>
      <style>{`
        ...
        .ben-btn-nuevo:hover { background: #b80000; }
        ...
        .ben-search:focus { border-color: rgba(153,0,0,0.35); }
        ...
        .ben-perfil-card.seleccionado { border-color: #990000; background: rgba(153,0,0,0.04); }
        ...
        .ben-pct-badge { font-size: 9px; padding: 2px 7px; border-radius: 10px; background: rgba(153,0,0,0.1); border: 1px solid rgba(153,0,0,0.2); color: rgba(153,0,0,0.8); font-family: 'Montserrat',sans-serif; font-weight: 700; }
        ...
        .ben-filtro-btn.activo { border-color: #990000; background: rgba(153,0,0,0.1); color: #fff; }
        ...
        .ben-acc-del { background: transparent; border: 1px solid rgba(153,0,0,0.15); color: rgba(153,0,0,0.45); }
        ...
        .ben-modal { background: #0f0f0f; border: 1px solid rgba(153,0,0,0.22); border-radius: 8px; padding: 26px 30px; width: 100%; max-width: 520px; margin: auto; position: relative; }
        ...
        .ben-input:focus { border-color: rgba(153,0,0,0.45); }
        ...
        .ben-tipo-item.on { border-color: rgba(153,0,0,0.3); background: rgba(153,0,0,0.07); }
        ...
        .ben-preview { background: rgba(153,0,0,0.05); border: 1px solid rgba(153,0,0,0.15); border-radius: 5px; padding: 10px 14px; margin-top: 12px; }
        ...
        {items.map(b => {
          ...
          return (
            <tr key={b.id}>
              <td>
                <span
                  style={{cursor: onPerfilClick ? "pointer" : "default", color: onPerfilClick ? "rgba(153,0,0,0.7)" : "inherit"}}

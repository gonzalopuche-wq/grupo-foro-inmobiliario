      ...
      <div style={{ maxWidth: 900, display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        {newSecret && (
          <div className="wh-secret-box">
            ...
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", marginBottom: 10, fontFamily: "Inter,sans-serif" }}>
        ...
        {showForm && (
          <div className="wh-card" style={{ borderColor: "rgba(153,0,0,0.2)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginBottom: 5, fontFamily: "Montserrat,sans-serif", fontWeight: 600, letterSpacing: "0.08em" }}>NOMBRE</div>
                <input className="wh-input" placeholder="Ej: Mi sistema CRM" value={nombre} onChange={e => setNombre(e.target.value)} />
              </div>
              <div>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginBottom: 5, fontFamily: "Montserrat,sans-serif", fontWeight: 600, letterSpacing: "0.08em" }}>URL DEL ENDPOINT</div>
                <input className="wh-input" placeholder="https://mi-sistema.com/webhook" value={url} onChange={e => setUrl(e.target.value)} />
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.2)", marginTop: 4, fontFamily: "Inter,sans-serif" }}>Debe ser HTTPS y aceptar POST con Content-Type: application/json</div>
              </div>
              <div>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginBottom: 8, fontFamily: "Montserrat,sans-serif", fontWeight: 600, letterSpacing: "0.08em" }}>EVENTOS A RECIBIR</div>
        ...
        <div className="wh-card">
          {loading ? (
            <div style={{ textAlign: "center", padding: 40, color: "rgba(255,255,255,0.3)", fontFamily: "Inter,sans-serif" }}>Cargando…</div>
          ) : hooks.length === 0 ? (
            <div style={{ textAlign: "center", padding: 48, color: "rgba(255,255,255,0.2)", fontFamily: "Inter,sans-serif", fontSize: 13, fontStyle: "italic" }}>
                ...
                {hooks.map(hook => (
                  <tr key={hook.id}>
                    <td>
                      ...
                      <div style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", fontFamily: "monospace", wordBreak: "break-all" }}>{hook.url}</div>
                    </td>
                    <td>
        ...
        {logs.length > 0 && (
          <div className="wh-card">
            <div style={{ fontFamily: "Montserrat,sans-serif", fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.3)", letterSpacing: "0.12em", marginBottom: 14 }}>
              ÚLTIMAS ENTREGAS
            </div>
            <table className="wh-table">
              <thead>
              ...
              <tbody>
                {logs.map(log => (
                  <tr key={log.id}>
                    ...
                    <td style={{ color: "rgba(255,255,255,0.3)", fontSize: 11 }}>{fmt(log.created_at)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="wh-card" style={{ fontSize: 12, color: "rgba(255,255,255,0.4)", lineHeight: 1.8, fontFamily: "Inter,sans-serif" }}>
          <div style={{ fontFamily: "Montserrat,sans-serif", fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.3)", letterSpacing: "0.1em", marginBottom: 10 }}>VERIFICACIÓN HMAC</div>

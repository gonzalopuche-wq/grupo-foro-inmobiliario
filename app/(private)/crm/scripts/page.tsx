...
const SCRIPTS: Script[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      { titulo: "Confirmar documentación", guion: "Vamos a necesitar: DNI vigente de todos los firmantes, título de propiedad original, libre deuda de ABL y expensas, y el informe de dominio actualizado. ¿Tiene todo eso a mano?", tips: "Repasar el checklist de documentación. Si falta algo, aclararlo antes de la fecha." },

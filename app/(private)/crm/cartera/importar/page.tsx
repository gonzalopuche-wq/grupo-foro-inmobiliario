  ...
  return (
    <>
      <style>{`
        ...
        .imp-drop:hover, .imp-drop.over { border-color: #cc0000; background: rgba(204,0,0,0.05); }
        ...
        .imp-btn-primary { background: #cc0000; color: #fff; }
        .imp-btn-primary:hover { background: #e00; }
        .imp-btn-primary:disabled { background: rgba(204,0,0,0.3); cursor: not-allowed; }
        ...
        /* Error */
        .imp-error { padding: 10px 14px; background: rgba(204,0,0,0.08); border: 1px solid rgba(204,0,0,0.25); border-radius: 6px; font-size: 12px; color: rgba(255,100,100,0.9); font-family: 'Inter',sans-serif; }
        /* Tabla preview */
        ...
        /* Checkbox */
        .imp-cb { width: 15px; height: 15px; cursor: pointer; accent-color: #cc0000; }
        /* Spinner */
        .imp-spinner { width: 16px; height: 16px; border: 2px solid rgba(255,255,255,0.1); border-top-color: #cc0000; border-radius: 50%; animation: spin 0.7s linear infinite; display: inline-block; vertical-align: middle; margin-right: 6px; }
        @keyframes spin { to { transform: rotate(360deg); } }
        /* Resultado */
        .imp-success { text-align: center; padding: 40px 20px; }
        .imp-success-icon { font-size: 48px; margin-bottom: 14px; }
        .imp-success-num { font-family: 'Montserrat',sans-serif; font-size: 52px; font-weight: 800; color: #22c55e; line-height: 1; }
            ...
            <div key={n} style={{ display: "flex", alignItems: "center", flex: i < 3 ? 1 : undefined }}>
              <div className="imp-step">
                <div className="imp-step-num" style={{
                  background: paso === n ? "#cc0000" : paso > n ? "rgba(34,197,94,0.2)" : "rgba(255,255,255,0.06)",
                  color: paso === n ? "#fff" : paso > n ? "#22c55e" : "rgba(255,255,255,0.3)",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
              <div style={{ fontSize: 13, color: "rgba(255,255,255,0.6)", fontFamily: "Inter,sans-serif" }}>
                ...
                <strong style={{ color: "#22c55e" }}>{seleccionados.size}</strong> seleccionadas para importar
              </div>
              <div style={{ display: "flex", gap: 8 }}>
                    ...
                    {preview.map((row, i) => {
                      ...
                      return (
                        <tr key={row.idx} className={sel ? "" : "excluida"} onClick={() => toggleSeleccion(row.idx)} style={{ cursor: "pointer" }}>
                          ...
                          <td>
                            <span className="imp-badge" style={{ background: "rgba(59,130,246,0.15)", color: "#60a5fa", border: "1px solid rgba(59,130,246,0.2)" }}>
                              {row.tipo}
                            </span>
                          </td>
                          <td>
                            <span className="imp-badge" style={{
                              ...
                              color: row.operacion === "Venta" ? "#22c55e" : "#eab308",
          ...
          <div className="imp-card">
            <div className="imp-success">
              ...
              {resultado.errores.length > 0 && (
                <div style={{ marginTop: 16, padding: "10px 14px", background: "rgba(234,179,8,0.08)", border: "1px solid rgba(234,179,8,0.2)", borderRadius: 6, fontSize: 11, color: "#eab308", textAlign: "left" }}>
              ...
              <div style={{ display: "flex", gap: 10, justifyContent: "center", marginTop: 20, flexWrap: "wrap" }}>
                <Link href="/crm/cartera" style={{ padding: "11px 22px", background: "#cc0000", borderRadius: 5, color: "#fff", fontFamily: "Montserrat,sans-serif", fontSize: 11, fontWeight: 700, textDecoration: "none", letterSpacing: "0.1em" }}>
                  Ver cartera →
                </Link>
                <button

  ...
  return (
    <>
      <style>{`
        ...
        .nf-item-cuerpo { font-size: 12px; color: var(--gfi-text-muted); line-height: 1.5; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; }
        .nf-item-meta { font-size: 10px; color: var(--gfi-text-dim); display: flex; gap: 8px; align-items: center; margin-top: auto; }
        .nf-dest-badge { font-size: 8px; background: rgba(234,179,8,0.12); border: 1px solid rgba(234,179,8,0.25); color: #d4960c; padding: 1px 5px; border-radius: 3px; font-family: var(--font-display); font-weight: 700; }
        .nf-empty { padding: 48px 24px; text-align: center; color: var(--gfi-text-dim); font-size: 13px; font-style: italic; background: var(--gfi-bg-card); border: 1px solid var(--gfi-border-subtle); border-radius: 6px; }
        ...
        .nf-modal-fuente { font-size: 10px; color: #990000; font-family: var(--font-display); font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px; }
        ...
        .nf-form-title { font-family: var(--font-display); font-size: 14px; font-weight: 800; color: #fff; margin-bottom: 16px; }
        ...
        .nf-btn-submit { padding: 9px 22px; background: #990000; border: none; border-radius: 4px; color: #fff; font-family: var(--font-display); font-size: 10px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; cursor: pointer; }
        .nf-btn-submit:disabled { opacity: 0.6; cursor: not-allowed; }
        .nf-spinner { display: inline-block; width: 11px; height: 11px; border: 2px solid var(--gfi-text-muted); border-top-color: #fff; border-radius: 50%; animation: nf-spin 0.7s linear infinite; margin-right: 5px; vertical-align: middle; }
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div className="nf-topbar">
          <div style={{ fontFamily: "var(--font-display)", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--gfi-text-muted)" }}>
            Noticias del sector
          </div>
            ...
            <div key={n.id} className={`nf-item${n.destacado ? " dest" : ""}`} onClick={() => setActiva(n)}>
              ...
              <div className="nf-item-info">
                ...
                <div className="nf-item-meta">
                  ...
                  {n.link && <span style={{ color: "#4ab8d8" }}>🔗 Ver fuente</span>}
                </div>
              </div>
            </div>
          ))

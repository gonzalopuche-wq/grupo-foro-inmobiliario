  ...
  return (
    <>
      <style>{`
        ...
        .nf-btn-nueva { padding: 9px 18px; background: #990000; border: none; border-radius: 4px; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; cursor: pointer; white-space: nowrap; }
        ...
        .nf-item-fuente { font-size: 9px; color: #990000; font-family: 'Montserrat', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; }
        ...
        .nf-dest-badge { font-size: 8px; background: rgba(234,179,8,0.12); border: 1px solid rgba(234,179,8,0.25); color: #d4960c; padding: 1px 5px; border-radius: 3px; font-family: 'Montserrat', sans-serif; font-weight: 700; }
        ...
        .nf-modal-fuente { font-size: 10px; color: #990000; font-family: 'Montserrat', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px; }
        ...
        .nf-btn-submit { padding: 9px 22px; background: #990000; border: none; border-radius: 4px; color: #fff; font-family: 'Montserrat', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; cursor: pointer; }

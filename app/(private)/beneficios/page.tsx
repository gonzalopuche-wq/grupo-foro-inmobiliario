  ...
  return (
    <>
      <style>{`
        ...
        .bn-filtro.activo{border-color:rgba(153,0,0,0.4);background:rgba(153,0,0,0.1);color:#990000}
        ...
        .bn-card{background:#0f0f0f;border:1px solid rgba(153,0,0,0.2);border-radius:10px;overflow:hidden;transition:border-color 0.2s;position:relative}
        .bn-card:hover{border-color:rgba(153,0,0,0.4)}
        .bn-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px;background:linear-gradient(90deg,transparent,#990000 40%,transparent)}
        .bn-imagen{width:100%;height:180px;object-fit:cover;display:block;background:rgba(153,0,0,0.07)}
        .bn-imagen-ph{width:100%;height:180px;background:linear-gradient(135deg,rgba(153,0,0,0.08),rgba(0,0,0,0.3));display:flex;align-items:center;justify-content:center;font-size:48px}
        ...
        .bn-sponsor-logo-ph{width:28px;height:28px;border-radius:6px;background:rgba(153,0,0,0.1);display:flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0}
        ...
        .bn-btn-interes{flex:1;padding:9px 14px;border-radius:5px;font-family:var(--font-display);font-size:9px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;cursor:pointer;transition:all 0.2s;border:1px solid rgba(153,0,0,0.4);background:rgba(153,0,0,0.1);color:#990000;white-space:nowrap}
        .bn-btn-interes:hover:not(:disabled){background:rgba(153,0,0,0.2)}
        ...
        .bn-spin{width:28px;height:28px;border:2px solid rgba(153,0,0,0.2);border-top-color:#990000;border-radius:50%;animation:spin 0.7s linear infinite}

...
export default function GrupoChatPage() {
  ...
  return (
    <>
      <style>{`
        .gc{display:flex;flex-direction:column;height:calc(100vh - 110px);background:var(--gfi-bg-primary);border-radius:var(--gfi-radius-lg);overflow:hidden;border:1px solid var(--gfi-border);}
        /* Header */
        .gc-hd{display:flex;align-items:center;gap:12px;padding:12px 16px;border-bottom:1px solid var(--gfi-border);background:linear-gradient(180deg,var(--gfi-bg-panel) 0%,var(--gfi-bg-secondary) 100%);flex-shrink:0;}
        .gc-back{background:none;border:none;color:var(--gfi-text-secondary);font-size:18px;cursor:pointer;padding:4px 8px;transition:var(--gfi-transition);}
        .gc-back:hover{color:var(--gfi-text-primary);}
        .gc-ico{width:40px;height:40px;border-radius:var(--gfi-radius-md);background:var(--gfi-red-soft);border:1px solid var(--gfi-red-border);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;box-shadow:var(--gfi-shadow-red);}
        .gc-hn{font-family:var(--font-display);font-size:15px;font-weight:800;color:var(--gfi-text-primary);letter-spacing:-0.01em;}
        .gc-hs{font-size:10px;color:var(--gfi-text-muted);margin-top:1px;font-family:var(--font-body);}
        .gc-mir-b{font-size:9px;padding:2px 8px;border-radius:var(--gfi-radius-sm);background:var(--gfi-red-soft);border:1px solid var(--gfi-red-border);color:var(--gfi-red);font-family:var(--font-display);font-weight:700;letter-spacing:0.08em;text-transform:uppercase;}
        .gc-sb{background:transparent;border:1px solid var(--gfi-border);border-radius:var(--gfi-radius-md);color:var(--gfi-text-secondary);cursor:pointer;font-size:14px;padding:6px 10px;transition:var(--gfi-transition);}
        .gc-sb:hover{border-color:var(--gfi-border-bright);color:var(--gfi-text-primary);}
        .gc-sb.on{background:var(--gfi-red-soft);border-color:var(--gfi-red-border);color:var(--gfi-red);}
        .gc-si{padding:10px 16px;background:var(--gfi-bg-input);border:none;border-bottom:1px solid var(--gfi-border);color:var(--gfi-text-primary);font-size:13px;outline:none;font-family:var(--font-body);width:100%;box-sizing:border-box;transition:var(--gfi-transition);}
        /* Messages area */
        .gc-msgs{flex:1;overflow-y:auto;padding:16px;display:flex;flex-direction:column;gap:2px;}
        .gc-day{text-align:center;margin:12px 0;}
        .gc-day span{font-size:10px;font-family:var(--font-display);font-weight:700;color:var(--gfi-text-muted);background:var(--gfi-bg-secondary);border:1px solid var(--gfi-border);border-radius:20px;padding:3px 14px;display:inline-block;letter-spacing:0.06em;}
        .gc-m{display:flex;gap:10px;padding:4px 0;position:relative;animation:gfi-fade-in 0.15s ease;}
        .gc-m.me{flex-direction:row-reverse;}
        /* Avatar with role ring */
        .gc-av{width:32px;height:32px;border-radius:var(--gfi-radius-md);background:var(--gfi-red-soft);border:2px solid var(--gfi-red-border);display:flex;align-items:center;justify-content:center;font-family:var(--font-display);font-size:10px;font-weight:800;color:var(--gfi-red);flex-shrink:0;overflow:hidden;align-self:flex-end;}
        ...
        .gc-id-n{font-family:var(--font-display);font-size:11px;font-weight:700;color:var(--gfi-red);}
        .gc-id-m{font-size:10px;color:var(--gfi-text-muted);font-family:var(--font-mono);font-weight:500;}
        /* Bubble styles */
        ...
        .gc-meta{display:flex;align-items:center;gap:6px;margin-top:4px;}
        .gc-m.me .gc-meta{justify-content:flex-end;}
        .gc-hora{font-size:9px;color:var(--gfi-text-muted);font-family:var(--font-mono);}
        .gc-edit-badge{font-size:9px;color:var(--gfi-text-muted);font-style:italic;}
        .gc-reacs{display:flex;gap:4px;flex-wrap:wrap;margin-top:5px;}
        .gc-reac{background:var(--gfi-bg-secondary);border:1px solid var(--gfi-border);border-radius:12px;padding:2px 8px;font-size:12px;cursor:pointer;display:flex;align-items:center;gap:4px;transition:var(--gfi-transition);}
        .gc-reac:hover{border-color:var(--gfi-border-bright);}
        .gc-reac.mia{background:var(--gfi-red-soft);border-color:var(--gfi-red-border);}
        /* Context menu */
        .gc-menu{position:absolute;background:var(--gfi-bg-elevated);border:1px solid var(--gfi-border-bright);border-radius:var(--gfi-radius-lg);padding:8px 6px;z-index:200;box-shadow:var(--gfi-shadow-lg);min-width:175px;}
        .gc-menu-emojis{display:flex;gap:2px;padding:2px 4px 8px;border-bottom:1px solid var(--gfi-border);margin-bottom:4px;flex-wrap:wrap;max-width:220px;}
        .gc-menu-emojis button{background:none;border:none;cursor:pointer;font-size:19px;padding:2px 4px;border-radius:var(--gfi-radius-sm);transition:var(--gfi-transition);}
        .gc-menu-emojis button:hover{background:var(--gfi-bg-hover);}
        ...
        .gc-rb-t{flex:1;font-size:11px;color:var(--gfi-text-secondary);font-family:var(--font-body);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
        /* Attach button */
        .gc-adb{width:36px;height:36px;background:transparent;border:1px solid var(--gfi-border);border-radius:var(--gfi-radius-md);color:var(--gfi-text-secondary);font-size:16px;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;transition:var(--gfi-transition);}
        .gc-adb:hover,.gc-adb-on{border-color:var(--gfi-red-border);color:var(--gfi-red);background:var(--gfi-red-soft);}
        /* Message textarea */
        .gc-ta{flex:1;padding:9px 13px;background:var(--gfi-bg-input);border:1px solid var(--gfi-border);border-radius:var(--gfi-radius-md);color:var(--gfi-text-primary);font-size:13px;outline:none;font-family:var(--font-body);resize:none;line-height:1.5;max-height:120px;overflow-y:auto;transition:var(--gfi-transition);}
        .gc-ta:focus{border-color:var(--gfi-red);box-shadow:0 0 0 3px var(--gfi-red-glow);}
        .gc-ta::placeholder{color:var(--gfi-text-muted);}
        /* Send button */
        .gc-send{padding:9px 18px;background:var(--gfi-red-gradient);border:none;border-radius:var(--gfi-radius-md);color:#fff;font-family:var(--font-display);font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;cursor:pointer;white-space:nowrap;flex-shrink:0;box-shadow:var(--gfi-shadow-red);transition:var(--gfi-transition);}
        .gc-send:hover{box-shadow:var(--gfi-shadow-red-lg);transform:translateY(-1px);}
        .gc-send:disabled{opacity:0.4;cursor:not-allowed;transform:none;}
        /* Recording dot */
        .gc-adot{width:10px;height:10px;border-radius:50%;background:var(--gfi-red);animation:gfi-dot 1.2s ease-in-out infinite;flex-shrink:0;}
        .gc-aprev{display:flex;align-items:center;gap:8px;padding:8px 12px;background:var(--gfi-bg-secondary);border:1px solid var(--gfi-border);border-radius:var(--gfi-radius-md);}
        .gc-thumbs{display:flex;gap:6px;flex-wrap:wrap;}
        .gc-thumb{position:relative;width:58px;height:58px;border-radius:var(--gfi-radius-md);overflow:hidden;background:var(--gfi-bg-secondary);border:1px solid var(--gfi-border);}
        .gc-thumb img{width:100%;height:100%;object-fit:cover;}
        .gc-thumb-x{position:absolute;top:2px;right:2px;width:16px;height:16px;border-radius:50%;background:rgba(0,0,0,0.75);border:none;color:#fff;font-size:10px;cursor:pointer;display:flex;align-items:center;justify-content:center;}
        .gc-a-audio{display:flex;align-items:center;gap:8px;background:var(--gfi-red-soft);border:1px solid var(--gfi-red-border);border-radius:var(--gfi-radius-md);padding:8px 10px;margin-top:4px;}
        .gc-a-doc{display:flex;align-items:center;gap:8px;background:var(--gfi-bg-secondary);border:1px solid var(--gfi-border);border-radius:var(--gfi-radius-md);padding:7px 10px;margin-top:4px;text-decoration:none;transition:var(--gfi-transition);}
      ...
      <div className="gc" onClick={() => { setMenuId(null); setMenuAdj(false); }}>
              ...
              {msgs.map(m => {
                ...
                return (
                  <div key={m.id} className={`gc-m${mio?" me":""}`}>
                    ...
                    <div className="gc-bw">
                      {/* Identidad COCIR */}
                      {!mio && !elim && <div className="gc-id"><span className="gc-id-n">{fullName(p)}</span><span className="gc-id-m" style={!p?.matricula?{color:"rgba(153,0,0,0.35)"}:{}}>{p?.matricula ? `Mat. ${p.matricula}` : "Sin matrícula"}</span></div>}
                      {mio && !elim && <div className="gc-id"><span className="gc-id-m" style={{color:"rgba(255,255,255,0.18)"}}>{userPerfil?.matricula ? `Mat. ${userPerfil.matricula}` : "Sin matrícula"}</span><span className="gc-id-n" style={{color:"var(--gfi-text-muted)"}}>Vos</span></div>}
                          ...
                          : editandoId===m.id ? (
                            <div>
                              ...
                              <div style={{display:"flex",gap:6,marginTop:5,justifyContent:"flex-end"}}>
                                <button onClick={()=>setEditandoId(null)} style={{fontSize:10,background:"none",border:"1px solid rgba(255,255,255,0.15)",borderRadius:3,color:"var(--gfi-text-muted)",padding:"3px 8px",cursor:"pointer",fontFamily:"Montserrat,sans-serif",fontWeight:700}}>Cancelar</button>
                            ...
                            <>
                              ...
                              {adjs.map((a,i) => {
                                ...
                                if (a.tipo==="contacto") {
                                  ...
                                  return (
                                    <div key={i} style={{marginTop:4,background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:12,overflow:"hidden",width:260}}>
                                      {/* Header */}
                                      <div style={{background:"rgba(153,0,0,0.12)",borderBottom:"1px solid rgba(153,0,0,0.15)",padding:"10px 12px",display:"flex",alignItems:"center",gap:10}}>
                                        {a.url
                                          ? <img src={a.url} alt={a.nombre} referrerPolicy="no-referrer" style={{width:42,height:42,borderRadius:"50%",objectFit:"cover",border:"2px solid rgba(153,0,0,0.3)"}}/>
                                          : <div style={{width:42,height:42,borderRadius:"50%",background:"rgba(153,0,0,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,color:"rgba(153,0,0,0.7)",fontWeight:800,fontFamily:"Montserrat,sans-serif"}}>{a.nombre.split(",").map((p:string)=>p.trim().charAt(0)).join("").slice(0,2).toUpperCase()}</div>
                                        }
                                        <div style={{flex:1,minWidth:0}}>
                                          ...
                                          {a.contacto_matricula && <div style={{fontSize:10,color:"rgba(153,0,0,0.8)",fontFamily:"Montserrat,sans-serif",fontWeight:700,letterSpacing:"0.05em"}}>Mat. {a.contacto_matricula}</div>}
                                        </div>
                                      </div>
                                      {/* Info */}
                                      <div style={{padding:"8px 12px",display:"flex",flexDirection:"column",gap:4}}>
                                        {a.contacto_telefono && <div style={{fontSize:11,color:"var(--gfi-text-secondary)",display:"flex",alignItems:"center",gap:6}}>📞 <span style={{fontFamily:"'Courier New',monospace"}}>{a.contacto_telefono}</span></div>}
                                        {a.contacto_instagram && <div style={{fontSize:11,color:"var(--gfi-text-secondary)",display:"flex",alignItems:"center",gap:6}}>📸 <span>@{a.contacto_instagram.replace(/^@/,"")}</span></div>}
                                      </div>
                                      {/* Acción WhatsApp */}
                                      {waLink && (
                                ...
                                if (a.tipo==="ubicacion") {
                                  return (
                                    <a key={i} href={a.url} target="_blank" rel="noopener noreferrer" onClick={e=>e.stopPropagation()}
                                      style={{display:"flex",alignItems:"center",gap:10,marginTop:4,background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:12,padding:"10px 14px",textDecoration:"none",width:260}}>
                                      ...
                                      <div>
                                        ...
                                        {a.ubicacion_lat!=null && <div style={{fontSize:10,color:"var(--gfi-text-muted)",fontFamily:"Inter,sans-serif"}}>{a.ubicacion_lat.toFixed(5)}, {a.ubicacion_lng?.toFixed(5)}</div>}
                                ...
                                if (a.tipo==="encuesta") {
                                  ...
                                  return (
                                    <div key={i} style={{marginTop:4,background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:12,overflow:"hidden",width:260}}>
                                      <div style={{background:"rgba(153,0,0,0.12)",borderBottom:"1px solid rgba(153,0,0,0.15)",padding:"10px 14px"}}>
                                        <div style={{fontSize:10,color:"rgba(153,0,0,0.7)",fontFamily:"Montserrat,sans-serif",fontWeight:700,letterSpacing:"0.1em",marginBottom:4}}>📊 ENCUESTA</div>
                                      ...
                                      <div style={{padding:"10px 12px",display:"flex",flexDirection:"column",gap:6}}>
                                        {(a.encuesta_opciones??[]).map((op,oi)=>{
                                          ...
                                          return (
                                            <button key={oi} onClick={e=>{e.stopPropagation();votarEncuesta(m.id,i,oi);}}
                                              style={{background:sel?"rgba(153,0,0,0.15)":"var(--gfi-border-subtle)",border:`1px solid ${sel?"rgba(153,0,0,0.4)":"rgba(255,255,255,0.09)"}`,borderRadius:6,padding:"7px 10px",cursor:"pointer",textAlign:"left",position:"relative",overflow:"hidden"}}>
                                              <div style={{position:"absolute",left:0,top:0,height:"100%",width:`${pct}%`,background:sel?"rgba(153,0,0,0.2)":"rgba(255,255,255,0.06)",transition:"width 0.4s"}}/>
                                        ...
                                        <div style={{fontSize:10,color:"var(--gfi-text-muted)",fontFamily:"Inter,sans-serif",textAlign:"right",marginTop:2}}>{total} {total===1?"voto":"votos"}</div>
                                      </div>
                                    </div>
                                  );
                                }
                                if (a.tipo==="evento") {
                                  ...
                                  return (
                                    <div key={i} style={{marginTop:4,background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:12,overflow:"hidden",width:260}}>
                                      <div style={{background:"rgba(153,0,0,0.12)",borderBottom:"1px solid rgba(153,0,0,0.2)",padding:"10px 14px",display:"flex",alignItems:"center",gap:10}}>
                                        <div style={{width:42,height:42,borderRadius:10,background:"rgba(153,0,0,0.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,flexShrink:0}}>📅</div>
                                        <div style={{flex:1,minWidth:0}}>
                                          <div style={{fontSize:10,color:"rgba(153,0,0,0.8)",fontFamily:"Montserrat,sans-serif",fontWeight:700,letterSpacing:"0.1em",marginBottom:2}}>EVENTO GFI®</div>
                                          ...
                                          {fecha&&<div style={{fontSize:11,color:"var(--gfi-text-secondary)",marginTop:1,textTransform:"capitalize"}}>{fecha}</div>}
                                        </div>
                                      </div>
                                      {a.evento_descripcion&&<div style={{padding:"8px 14px",fontSize:12,color:"var(--gfi-text-secondary)",fontFamily:"Inter,sans-serif"}}>{a.evento_descripcion}</div>}
                                      <div style={{display:"flex",borderTop:"1px solid rgba(255,255,255,0.06)"}}>
                                        <a href="/eventos" onClick={e=>e.stopPropagation()}
                                          style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",gap:5,background:"rgba(153,0,0,0.08)",padding:"8px 10px",textDecoration:"none",color:"#990000",fontSize:11,fontFamily:"Montserrat,sans-serif",fontWeight:700}}>
                                          Ver en GFI
                                        </a>
                                        {calLink&&(
                      ...
                      {Object.keys(reacs).length > 0 && !elim && (
                        <div className="gc-reacs" style={{justifyContent:mio?"flex-end":"flex-start"}}>
                          {Object.entries(reacs).map(([e,us]) => <button key={e} className={`gc-reac${(us as string[]).includes(userId??"")?" mia":""}`} onClick={ev=>{ev.stopPropagation();reaccionar(m.id,e);}}>{e} <span style={{fontSize:10,color:"var(--gfi-text-secondary)"}}>{(us as string[]).length}</span></button>)}
                        </div>
                      )}
                    </div>
                  </div>
        ...
        {/* Input */}
        <div className="gc-ia">
          {replyMsg && <div className="gc-rb"><span style={{fontSize:12,color:"rgba(153,0,0,0.6)",fontFamily:"Montserrat,sans-serif",fontWeight:700}}>↩</span><span className="gc-rb-t">{fullName(replyMsg.perfiles)}: {replyMsg.texto??"🎙 Audio"}</span><button style={{background:"none",border:"none",color:"var(--gfi-text-muted)",cursor:"pointer",fontSize:16,padding:0}} onClick={()=>setReplyMsg(null)}>×</button></div>}
          ...
          {grabando && (
            <div style={{display:"flex",flexDirection:"column",gap:10,padding:"12px 14px",background:"rgba(153,0,0,0.08)",border:"1px solid rgba(153,0,0,0.25)",borderRadius:8}}>
              ...
              <div style={{display:"flex",gap:8}}>
                ...
                <button onClick={cancelarAudio} style={{padding:"12px 16px",background:"transparent",border:"1px solid rgba(255,255,255,0.15)",borderRadius:8,color:"var(--gfi-text-secondary)",fontFamily:"Montserrat,sans-serif",fontSize:13,fontWeight:700,cursor:"pointer"}}>✕</button>
              </div>
            </div>
          )}
          {audioUrl && !grabando && (
      ...
      {menuAdj && (
        <div onClick={()=>setMenuAdj(false)} style={{position:"fixed",inset:0,zIndex:600}}>
          <div onClick={e=>e.stopPropagation()} style={{position:"fixed",bottom:80,left:0,right:0,margin:"0 auto",maxWidth:500,background:"#181818",border:"1px solid var(--gfi-border)",borderRadius:"16px 16px 0 0",padding:"18px 14px 24px",zIndex:601}}>
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10}}>
              {([
                ...
                <button key={label} onClick={action} style={{display:"flex",flexDirection:"column",alignItems:"center",gap:6,background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:12,padding:"12px 6px",cursor:"pointer"}}>
                  <div style={{width:46,height:46,borderRadius:"50%",background:"rgba(153,0,0,0.12)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:22}}>{icon}</div>
      ...
      {modalContacto && (
        <div onClick={()=>setModalContacto(false)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:1000,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
          <div onClick={e=>e.stopPropagation()} style={{background:"var(--gfi-bg-secondary)",borderRadius:"12px 12px 0 0",width:"100%",maxWidth:500,maxHeight:"70vh",display:"flex",flexDirection:"column"}}>
            <div style={{padding:"14px 16px",borderBottom:"1px solid var(--gfi-border)",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <span style={{fontFamily:"Montserrat,sans-serif",fontWeight:700,fontSize:13,color:"#fff"}}>👤 Compartir contacto</span>
              <button onClick={()=>setModalContacto(false)} style={{background:"none",border:"none",color:"var(--gfi-text-muted)",fontSize:22,cursor:"pointer"}}>×</button>
            </div>
            <div style={{padding:"10px 14px"}}>
              <input value={busqContacto} onChange={e=>setBusqContacto(e.target.value)} placeholder="Buscar por nombre o matrícula..." autoFocus
                style={{width:"100%",padding:"8px 10px",background:"rgba(255,255,255,0.06)",border:"1px solid var(--gfi-border)",borderRadius:6,color:"#fff",fontSize:12,fontFamily:"Inter,sans-serif",outline:"none",boxSizing:"border-box"}}/>
            </div>
            <div style={{overflowY:"auto",flex:1}}>
              {loadingMiembros ? (
                <div style={{padding:24,textAlign:"center",color:"var(--gfi-text-muted)",fontSize:12}}>Cargando miembros...</div>
              ) : (
                miembros.filter(mm=>{const q=busqContacto.toLowerCase();return !q||`${mm.nombre} ${mm.apellido} ${mm.matricula??""}`.toLowerCase().includes(q);}).map(mm=>(
                  <button key={mm.id} onClick={()=>compartirContacto(mm)} style={{width:"100%",display:"flex",alignItems:"center",gap:12,padding:"10px 14px",background:"none",border:"none",borderBottom:"1px solid var(--gfi-border-subtle)",cursor:"pointer",textAlign:"left"}}>
                    {mm.foto_url
                      ...
                      :<div style={{width:40,height:40,borderRadius:"50%",background:"rgba(153,0,0,0.15)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:15,fontWeight:800,color:"rgba(153,0,0,0.7)",fontFamily:"Montserrat,sans-serif",flexShrink:0}}>{`${mm.nombre?.charAt(0)??""}${mm.apellido?.charAt(0)??""}`.toUpperCase()}</div>
                    }
                    <div>
                      <div style={{fontSize:13,fontWeight:600,color:"#fff",fontFamily:"Inter,sans-serif"}}>{mm.apellido}, {mm.nombre}</div>
                      {mm.matricula&&<div style={{fontSize:10,color:"rgba(153,0,0,0.7)",fontFamily:"Montserrat,sans-serif",fontWeight:700}}>Mat. {mm.matricula}</div>}
                    </div>
                  </button>
                ))
              )}
      ...
      {modalEncuesta && (
        <div onClick={()=>setModalEncuesta(false)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:1000,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
          <div onClick={e=>e.stopPropagation()} style={{background:"var(--gfi-bg-secondary)",borderRadius:"12px 12px 0 0",width:"100%",maxWidth:500,padding:"20px 16px 28px",display:"flex",flexDirection:"column",gap:12}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <span style={{fontFamily:"Montserrat,sans-serif",fontWeight:800,fontSize:14,color:"#fff"}}>📊 Nueva encuesta</span>
              <button onClick={()=>setModalEncuesta(false)} style={{background:"none",border:"none",color:"var(--gfi-text-muted)",fontSize:22,cursor:"pointer"}}>×</button>
            </div>
            <input value={encuestaPregunta} onChange={e=>setEncuestaPregunta(e.target.value)} placeholder="¿Cuál es la pregunta?" autoFocus
              style={{padding:"10px 12px",background:"rgba(255,255,255,0.06)",border:"1px solid var(--gfi-border)",borderRadius:8,color:"#fff",fontSize:13,fontFamily:"Inter,sans-serif",outline:"none"}}/>
            <div style={{display:"flex",flexDirection:"column",gap:8}}>
              {encuestaOpciones.map((op,i)=>(
                <div key={i} style={{display:"flex",gap:6,alignItems:"center"}}>
                  <input value={op} onChange={e=>setEncuestaOpciones(prev=>{const n=[...prev];n[i]=e.target.value;return n;})} placeholder={`Opción ${i+1}`}
                    style={{flex:1,padding:"8px 10px",background:"var(--gfi-border-subtle)",border:"1px solid var(--gfi-border)",borderRadius:6,color:"#fff",fontSize:12,fontFamily:"Inter,sans-serif",outline:"none"}}/>
              ...
              {encuestaOpciones.length<6&&(
                <button onClick={()=>setEncuestaOpciones(prev=>[...prev,""])} style={{background:"none",border:"1px dashed rgba(255,255,255,0.15)",borderRadius:6,padding:"7px",color:"var(--gfi-text-muted)",fontSize:12,cursor:"pointer",fontFamily:"Montserrat,sans-serif",fontWeight:600}}>+ Agregar opción</button>
              )}
            </div>
        ...
        <div onClick={()=>setModalEvento(false)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:1000,display:"flex",alignItems:"flex-end",justifyContent:"center"}}>
          <div onClick={e=>e.stopPropagation()} style={{background:"var(--gfi-bg-secondary)",borderRadius:"12px 12px 0 0",width:"100%",maxWidth:500,padding:"20px 16px 28px",display:"flex",flexDirection:"column",gap:12}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              ...
              <button onClick={()=>setModalEvento(false)} style={{background:"none",border:"none",color:"var(--gfi-text-muted)",fontSize:22,cursor:"pointer"}}>×</button>
            </div>
            ...
            <input type="date" value={eventoFecha} onChange={e=>setEventoFecha(e.target.value)}
              style={{padding:"10px 12px",background:"rgba(255,255,255,0.06)",border:"1px solid var(--gfi-border)",borderRadius:8,color:"#fff",fontSize:13,fontFamily:"Inter,sans-serif",outline:"none",colorScheme:"dark"}}/>
            <textarea value={eventoDescripcion} onChange={e=>setEventoDescripcion(e.target.value)} placeholder="Descripción (opcional)" rows={2}
              style={{padding:"10px 12px",background:"rgba(255,255,255,0.06)",border:"1px solid var(--gfi-border)",borderRadius:8,color:"#fff",fontSize:12,fontFamily:"Inter,sans-serif",outline:"none",resize:"none"}}/>
        ...
        <div onClick={() => setModalMic(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.8)", zIndex: 10000, display: "flex", alignItems: "flex-end", justifyContent: "center", padding: "0 0 env(safe-area-inset-bottom,0)" }}>
          <div onClick={e => e.stopPropagation()} style={{ background: "#1a1a1a", borderRadius: "16px 16px 0 0", padding: "24px 20px 32px", width: "100%", maxWidth: 480, border: "1px solid var(--gfi-border)", borderBottom: "none" }}>
            ...
            <div style={{ background: "rgba(153,0,0,0.08)", border: "1px solid rgba(153,0,0,0.2)", borderRadius: 10, padding: "14px", marginBottom: 10 }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 11, fontWeight: 800, color: "#990000", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 10 }}>Desde Chrome Android</div>
              {[
                ...
                <div key={n} style={{ display: "flex", gap: 10, alignItems: "flex-start", marginBottom: 8 }}>
                  <div style={{ width: 22, height: 22, borderRadius: "50%", background: "#990000", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 800, fontFamily: "var(--font-display)", color: "#fff", flexShrink: 0 }}>{n}</div>

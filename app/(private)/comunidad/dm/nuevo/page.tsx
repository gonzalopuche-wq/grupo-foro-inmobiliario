    ...
    <div style={{ maxWidth: 600, margin: "0 auto" }}>
      ...
      <div style={{ background: "#111", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10, overflow: "hidden" }}>
        {filtrados.length === 0 ? (
          ...
          >
            <div style={{ width: 42, height: 42, borderRadius: "50%", background: "rgba(200,0,0,0.1)", border: "1px solid rgba(200,0,0,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontFamily: "Montserrat,sans-serif", fontWeight: 800, color: "#cc0000", flexShrink: 0, overflow: "hidden" }}>

  ...
  return (
    <>
      <style>{`
        ...
        .pv-btn-agregar{padding:10px 20px;background:#990000;border:none;border-radius:4px;color:#fff;font-family:'Montserrat',sans-serif;font-size:10px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;cursor:pointer;white-space:nowrap}
        ...
        .pv-rubro-badge{font-family:'Montserrat',sans-serif;font-size:9px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;padding:3px 9px;border-radius:20px;background:rgba(200,0,0,0.1);border:1px solid rgba(200,0,0,0.25);color:#990000;flex-shrink:0}
        ...
        .pv-sponsor-badge{font-family:'Montserrat',sans-serif;font-size:8px;font-weight:800;letter-spacing:0.14em;text-transform:uppercase;padding:2px 8px;border-radius:20px;background:rgba(200,0,0,0.15);border:1px solid rgba(200,0,0,0.4);color:#990000}
        ...
        .pv-sponsor-web{display:inline-flex;align-items:center;gap:5px;padding:6px 14px;background:rgba(200,0,0,0.1);border:1px solid rgba(200,0,0,0.3);border-radius:4px;color:#990000;font-family:'Montserrat',sans-serif;font-size:9px;font-weight:700;letter-spacing:0.1em;text-decoration:none;text-transform:uppercase;transition:all 0.2s;white-space:nowrap}
        ...
        .pv-sponsor-beneficio-label{font-family:'Montserrat',sans-serif;font-size:8px;font-weight:800;letter-spacing:0.16em;text-transform:uppercase;color:#990000}
        .pv-sponsor-beneficio-texto{font-size:12px;color:rgba(255,255,255,0.75);line-height:1.5}
        .pv-btn-interes{display:inline-flex;align-items:center;gap:6px;padding:7px 14px;border-radius:4px;font-family:'Montserrat',sans-serif;font-size:9px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;cursor:pointer;transition:all 0.2s;border:1px solid rgba(200,0,0,0.4);background:rgba(200,0,0,0.1);color:#990000;white-space:nowrap}
                ...
                <div className="pv-card-main">
                  <div className="pv-card-left">
                    ...
                    <div className="pv-referenciado">
                      ...
                      {esPropio && <span style={{fontSize:9,color:"#990000",fontWeight:700,background:"rgba(200,0,0,0.1)",border:"1px solid rgba(200,0,0,0.25)",padding:"1px 6px",borderRadius:10,fontFamily:"'Montserrat',sans-serif",letterSpacing:"0.08em"}}>TU REFERIDO</span>}
                    </div>
                    {(p.total_resenas ?? 0) > 0 && (

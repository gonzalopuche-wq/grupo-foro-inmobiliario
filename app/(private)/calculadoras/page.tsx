...
// Datos de fallback — valores reales de BCRA/INDEC (ICL y CER calculados de índice diario)
// Actualizado: Abr 2026 | ICL y CER 2026-04 disponibles; IPC llega hasta 2026-03 (INDEC publica ~15 del mes siguiente)
const FALLBACK_INDICES: IndicesData = {
  ...
  indices: {
    ICL: {
      "2024-01": 9.89, "2024-02": 12.33,"2024-03": 17.89,"2024-04": 14.90,
      "2024-05": 12.64,"2024-06": 12.23,"2024-07": 9.42, "2024-08": 5.57,
      "2024-09": 5.22, "2024-10": 4.75, "2024-11": 3.83, "2024-12": 4.32,
      "2025-01": 3.67, "2025-02": 2.33, "2025-03": 2.54, "2025-04": 3.25,
      "2025-05": 4.14, "2025-06": 3.34, "2025-07": 2.31, "2025-08": 1.95,
      "2025-09": 2.25, "2025-10": 2.02, "2025-11": 1.66, "2025-12": 2.12,
      "2026-01": 2.18, "2026-02": 1.83, "2026-03": 2.09, "2026-04": 2.85,
    },
    IPC: {
      "2024-01": 20.60,"2024-02": 13.20,"2024-03": 11.00,"2024-04": 8.80,
      "2024-05": 4.20, "2024-06": 4.60, "2024-07": 4.00, "2024-08": 4.20,
      "2024-09": 3.50, "2024-10": 2.70, "2024-11": 2.40, "2024-12": 2.70,
    ...
    CER: {
      ...
      "2024-05": 10.04,"2024-06": 6.33, "2024-07": 4.48, "2024-08": 4.29,
      "2024-09": 4.03, "2024-10": 3.91, "2024-11": 3.04, "2024-12": 2.59,
      "2025-01": 2.55, "2025-02": 2.33, "2025-03": 2.42, "2025-04": 3.01,
      "2025-05": 3.30, "2025-06": 2.10, "2025-07": 1.58, "2025-08": 1.75,
      "2025-09": 1.87, "2025-10": 2.03, "2025-11": 2.17, "2025-12": 2.44,
      "2026-01": 2.65, "2026-02": 2.70, "2026-03": 3.05, "2026-04": 3.10,
    },
  },
};
      ...
      <div className="c-wrap">
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", paddingBottom: 14, borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          {[
            ...
            { href: "/calculadoras/alquiler", label: "Ajuste Alquiler", icon: "🏠", active: false },
            { href: "/calculadoras/split", label: "Split Honorarios", icon: "🤝", active: false },
            { href: "/calculadoras/escritura", label: "Gastos Escritura", icon: "⚖️", active: false },
            { href: "/calculadoras/uva", label: "Hipoteca UVA", icon: "🏛️", active: false },
            { href: "/calculadoras/temporal", label: "Temporal vs Tradicional", icon: "🏖️", active: false },
            { href: "/calculadoras/flipping", label: "Flipping / Renovación", icon: "🔨", active: false },
            { href: "/calculadoras/pozo", label: "Dpto. en Pozo", icon: "🏗️", active: false },
            ...
            { href: "/calculadoras/credito-hipotecario", label: "Créditos Hipotecarios", icon: "🏦", active: false },
            { href: "/calculadoras/amortizacion", label: "Sistemas Amortización", icon: "📊", active: false },
            { href: "/calculadoras/van-irr", label: "VAN / IRR Inversión", icon: "📐", active: false },
            { href: "/calculadoras/renta-vs-compra", label: "Renta vs Compra", icon: "🏠", active: false },
            { href: "/calculadoras/impuestos-provinciales", label: "Impuestos Provinciales", icon: "🏛️", active: false },
            { href: "/calculadoras/reformas", label: "Reformas y Mejoras ROI", icon: "🔨", active: false },
            { href: "/calculadoras/pozo-avanzado", label: "Pozo Avanzado", icon: "🏗️", active: false },
            { href: "/calculadoras/temporario", label: "Temporario vs LP", icon: "🏖️", active: false },
            { href: "/calculadoras/pnl-inmobiliaria", label: "P&L Inmobiliaria", icon: "📊", active: false },
            { href: "/calculadoras/proyeccion-uva", label: "Proyección UVA", icon: "📈", active: false },
            { href: "/calculadoras/valuacion-ingresos", label: "Valuación por Ingresos", icon: "💼", active: false },
            { href: "/calculadoras/comparador", label: "Comparador de Propiedades", icon: "🏘️", active: false },
            { href: "/calculadoras/credito-uva", label: "Crédito UVA vs Tradicional", icon: "🏦", active: false },
            { href: "/calculadoras/valuacion-comparables", label: "Valuación por Comparables", icon: "🏘️", active: false },
            { href: "/calculadoras/fideicomiso", label: "Fideicomiso Inmobiliario", icon: "🏛️", active: false },
            { href: "/calculadoras/portfolio-rentas", label: "Portfolio de Rentas", icon: "🏘️", active: false },
            ...
            { href: "/calculadoras/rendimiento-comparado", label: "Rendimiento Comparado", icon: "📊", active: false },
            { href: "/calculadoras/plusvalia", label: "Análisis de Plusvalía", icon: "📈", active: false },
            { href: "/calculadoras/tipo-cambio", label: "Tipo de Cambio & Precios", icon: "💱", active: false },
            { href: "/calculadoras/airbnb", label: "Airbnb vs Alquiler Trad.", icon: "🏡", active: false },
            { href: "/calculadoras/expensas", label: "Calculadora de Expensas", icon: "🏢", active: false },
            { href: "/calculadoras/precio-m2", label: "Comparador Precio/m²", icon: "📐", active: false },
            { href: "/calculadoras/seguro-hogar", label: "Seguro de Hogar", icon: "🛡️", active: false },
            { href: "/calculadoras/honorarios-compartidos", label: "Honorarios Compartidos", icon: "🤝", active: false },
            { href: "/calculadoras/punto-equilibrio", label: "Punto de Equilibrio", icon: "⚖️", active: false },
            { href: "/calculadoras/capacidad-endeudamiento", label: "Capacidad de Endeudamiento", icon: "🏦", active: false },
            { href: "/calculadoras/renta-neta", label: "Renta Bruta → Neta", icon: "📊", active: false },
            { href: "/calculadoras/sensibilidad", label: "Análisis de Sensibilidad", icon: "🔬", active: false },
            { href: "/calculadoras/flujo-caja", label: "Flujo de Caja", icon: "💸", active: false },
            { href: "/calculadoras/inversion-pozo", label: "Inversión en Pozo", icon: "🏗️", active: false },
            { href: "/calculadoras/comparar-inversiones", label: "Comparar Inversiones", icon: "⚖️", active: false },
            { href: "/calculadoras/roi-renovacion", label: "ROI de Renovación", icon: "🔨", active: false },
            { href: "/calculadoras/gastos-escritura", label: "Gastos de Escritura", icon: "📜", active: false },
            { href: "/calculadoras/simulador-ajuste", label: "Simulador de Ajuste", icon: "📈", active: false },
            { href: "/calculadoras/comercial", label: "Alquiler Comercial", icon: "🏢", active: false },
            { href: "/calculadoras/leasing", label: "Leasing Inmobiliario", icon: "🏗️", active: false },
            ...
            { href: "/calculadoras/bienes-personales", label: "Bienes Personales", icon: "💼", active: false },
            { href: "/calculadoras/abl-municipal", label: "ABL Municipal", icon: "🏛️", active: false },
            ...
            { href: "/calculadoras/tir-van", label: "TIR & VAN", icon: "📊", active: false },
            { href: "/calculadoras/amortizacion-anticipada", label: "Amortización Anticipada", icon: "🏦", active: false },
            { href: "/calculadoras/accesibilidad", label: "Accesibilidad Vivienda", icon: "🏠", active: false },

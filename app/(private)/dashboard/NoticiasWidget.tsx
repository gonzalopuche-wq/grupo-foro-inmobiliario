  ...
  return (
    <>
      <style>{`
        ...
        .nw-card-fecha { font-size: 9px; color: var(--gfi-text-dim); margin-top: auto; padding-top: 5px; }
        .nw-empty { font-size: 12px; color: var(--gfi-text-dim); font-style: italic; padding: 20px 0; text-align: center; background: var(--gfi-bg-card); border: 1px solid var(--gfi-border-subtle); border-radius: 6px; }
        ...
        .nw-modal-fuente { font-size: 10px; color: #990000; font-family: var(--font-display); font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px; }
      ...
      <div className="nw-section">
        ...
        {loading ? (
          ...
          <div className="nw-empty">No hay noticias publicadas todavía. <a href="/noticias" style={{color:"#990000"}}>Sugerí una →</a></div>
        ) : (
          <div className="nw-grid">
            {noticias.map(n => (

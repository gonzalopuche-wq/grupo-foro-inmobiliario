  ...
  return (
    <>
      <style>{`
        ...
        .nw-card-fuente { font-size: 9px; color: #990000; font-family: 'Montserrat', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; }
        ...
        .nw-modal-fuente { font-size: 10px; color: #990000; font-family: 'Montserrat', sans-serif; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 8px; }

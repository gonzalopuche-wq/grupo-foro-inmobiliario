  ...
  return (
    <>
      <style>{`
        ...
        .drv-btn-nuevo:hover { background: #b80000; }
        ...
        .drv-card:hover { border-color: rgba(153,0,0,0.2); }
        ...
        .drv-btn-open { display: inline-flex; align-items: center; gap: 5px; padding: 7px 14px; background: rgba(153,0,0,0.1); border: 1px solid rgba(153,0,0,0.25); border-radius: 3px; color: #990000; font-family: var(--font-display); font-size: 9px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; text-decoration: none; transition: all 0.2s; cursor: pointer; }
        .drv-btn-open:hover { background: rgba(153,0,0,0.2); color: #fff; }
        ...
        .drv-btn-del { background: transparent; border-color: rgba(153,0,0,0.18); color: rgba(153,0,0,0.5); }
        .drv-btn-del:hover { background: rgba(153,0,0,0.1); border-color: #ff4444; color: #ff4444; }
        ...
        .drv-spin { width: 26px; height: 26px; border: 2px solid rgba(153,0,0,0.2); border-top-color: #990000; border-radius: 50%; animation: spin 0.7s linear infinite; }
        ...
        .modal { background: #0f0f0f; border: 1px solid rgba(153,0,0,0.25); border-radius: 6px; padding: 28px 30px; width: 100%; max-width: 500px; position: relative; max-height: 92vh; overflow-y: auto; }
        ...
        <div className="drv-header">
          <div>
            <div className="drv-titulo">
              <span>📁</span>
              <span>Google <span style={{ color: "#990000" }}>Drive</span></span>
            </div>

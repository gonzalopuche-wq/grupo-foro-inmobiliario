...
const GFI_SELECT = [
  ...
  "dormitorios,banos,toilettes,ambientes,superficie_cubierta,sup_terreno,sup_semicubierta,sup_descubierta,expensas",
  "orientacion,disposicion,piso,estacionamientos,bauleras,antiguedad",
  ...
  "com_bicicletero,com_microcine,com_sauna,com_conserjeria,com_portero_electrico,com_wifi_comunes,com_espacio_verde",
...
const EXT_SELECT = [
  ...
  "dormitorios,banos,toilettes,ambientes,superficie_cubierta,sup_terreno,sup_semicubierta,sup_descubierta,expensas",
  "orientacion,disposicion,piso,cocheras,baulera,antiguedad",
  "amoblado,acepta_mascotas,apto_credito",
...
export async function GET(
  ...
  if (fuente === "gfi") {
    ...
    return NextResponse.json({
      ...
      com_bicicletero: d.com_bicicletero ?? false,
      com_microcine: d.com_microcine ?? false,
      com_sauna: d.com_sauna ?? false,
      com_conserjeria: d.com_conserjeria ?? false,
      com_portero_electrico: d.com_portero_electrico ?? false,
      com_wifi_comunes: d.com_wifi_comunes ?? false,
      com_espacio_verde: d.com_espacio_verde ?? false,

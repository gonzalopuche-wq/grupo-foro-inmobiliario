    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .w-btn-wa { padding: 9px 18px; background: ${t.accent}; color: ${isDark ? "#fff" : "#fff"}; border-radius: 6px; font-size: 12px; font-weight: 700; font-family: 'Montserrat',sans-serif; letter-spacing: 0.05em; transition: opacity 0.2s; }
        ...
        .w-footer-redes { display: flex; gap: 12px; justify-content: center; margin: 12px 0; }
        .w-footer-red { width: 34px; height: 34px; border-radius: 8px; background: rgba(255,255,255,0.08); display: flex; align-items: center; justify-content: center; font-size: 16px; transition: background 0.2s; }
        .w-footer-red:hover { background: ${t.accent}; }
      ...
      <footer className="w-footer">
        ...
        {(cfg.instagram || cfg.facebook || cfg.twitter || cfg.linkedin) && (
          <div className="w-footer-redes">
            {cfg.instagram && <a href={cfg.instagram} target="_blank" rel="noopener noreferrer" className="w-footer-red">📸</a>}
            {cfg.facebook && <a href={cfg.facebook} target="_blank" rel="noopener noreferrer" className="w-footer-red">👤</a>}
            {cfg.twitter && <a href={cfg.twitter} target="_blank" rel="noopener noreferrer" className="w-footer-red">🐦</a>}
            {cfg.linkedin && <a href={cfg.linkedin} target="_blank" rel="noopener noreferrer" className="w-footer-red">💼</a>}
          </div>
        )}

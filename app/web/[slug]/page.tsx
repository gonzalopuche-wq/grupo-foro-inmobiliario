...
const TEMAS: Record<string, { bg: string; bgAlt: string; header: string; footer: string; accent: string; text: string; textMuted: string; card: string; cardBorder: string; fontH: string; }> = {
  "rosario-classic":   { bg:"#0a0a0a", bgAlt:"#111", header:"rgba(8,8,8,0.98)", footer:"#080808", accent:"#990000", text:"#fff", textMuted:"rgba(255,255,255,0.5)", card:"rgba(20,20,20,0.95)", cardBorder:"rgba(255,255,255,0.08)", fontH:"Montserrat,sans-serif" },
  ...
  "noche-portena":     { bg:"#0f1923", bgAlt:"#141f2e", header:"#0a1220", footer:"#080e18", accent:"#4ab8d8", text:"#e2e8f0", textMuted:"#64748b", card:"rgba(20,30,45,0.95)", cardBorder:"rgba(74,184,216,0.12)", fontH:"Montserrat,sans-serif" },
  "sol-norte":         { bg:"#fffbf0", bgAlt:"#fff7e6", header:"#fff", footer:"#1a1000", accent:"#d4960c", text:"#1a1000", textMuted:"#92400e", card:"#fff", cardBorder:"#fed7aa", fontH:"Montserrat,sans-serif" },
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .w-test-stars { color: #d4960c; font-size: 15px; letter-spacing: 2px; }
        ...
        .w-footer-gfi-redes { display: flex; gap: 8px; justify-content: center; margin: 10px 0 6px; }
        .w-footer-gfi-red { width: 28px; height: 28px; border-radius: 6px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.08); display: flex; align-items: center; justify-content: center; color: rgba(255,255,255,0.4); text-decoration: none; transition: background 0.18s, color 0.18s; }
        .w-footer-gfi-red:hover { background: rgba(153,0,0,0.25); color: #fff; border-color: rgba(153,0,0,0.4); }
            ...
            {propiedades.map(p => (
              <a key={p.id} href={`/web/${cfg.slug}/propiedad/${p.id}`} className="w-prop-card" style={p.destacada_web ? { borderColor: `${t.accent}60` } : {}}>
                <div className="w-prop-img">
                  ...
                  {p.destacada_web && (
                    <div style={{ position: "absolute", top: 8, left: 8, background: "rgba(0,0,0,0.72)", backdropFilter: "blur(4px)", borderRadius: 4, padding: "2px 7px", fontSize: 9, fontWeight: 700, color: "#d4960c", fontFamily: "Montserrat,sans-serif", letterSpacing: "0.06em", display: "flex", alignItems: "center", gap: 3 }}>
                      ⭐ DESTACADA
                    </div>
                  )}
                </div>
      ...
      <footer className="w-footer">
        ...
        <div className="w-footer-gfi">
          ...
          <div className="w-footer-gfi-redes">
            <a href="https://www.instagram.com/grupoforoinmobiliario?igsh=MWxpYjk1N244bjlwZA==" target="_blank" rel="noopener noreferrer" className="w-footer-gfi-red" aria-label="Instagram GFI">
            ...
            <a href="https://www.facebook.com/share/17PvDaRSef/" target="_blank" rel="noopener noreferrer" className="w-footer-gfi-red" aria-label="Facebook GFI">
              <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://x.com/ForoInmob?t=cprs_HeCTgfydn3bNbeuKw&s=09" target="_blank" rel="noopener noreferrer" className="w-footer-gfi-red" aria-label="X / Twitter GFI">
            ...
            <a href="https://youtube.com/@grupoforoinmobiliario?si=hKhmnMOG1ms541zL" target="_blank" rel="noopener noreferrer" className="w-footer-gfi-red" aria-label="YouTube GFI">
